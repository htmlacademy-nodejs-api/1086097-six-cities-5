...
import { ValidateObjectIdMiddleware, ValidateDtoMiddleware, DocumentExistsMiddleware, PrivateRouteMiddleware } from '../../libs/rest/index.js';
...
export class CommentController extends BaseController {
  ...
  constructor(
    ...
    this.addRoute({
      ...
      handler: this.showCommentsByOfferId,
      middlewares: [
